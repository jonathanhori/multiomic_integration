...
K = 5
K_l = 5
loading_sparsity = .25 # 25% of entries are 0
getwd()
...
mapply(function(n, p_l, snr_x, snr_y) {
  # Create output path
  out_path <- file.path("/Users/jonathanhori/Library/Mobile Documents/com~apple~CloudDocs/Projects/multiomic_integration/sim", #dirname(rstudioapi::getSourceEditorContext()$path), 
                        "data3",
...
```{r}
data_name_base <- "factor_data_n%sp%s_snr%s.%s.rds"
# saveRDS(sim_data, sprintf(data_name_base, N, p_l, snr_x, snr_y))
# saveRDS()
